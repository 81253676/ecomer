...
<html lang="es">
	<head>
	    ...
	    <meta name="keywords" content="MediaCenter, , eCommerce">
	    <meta name="robots" content="all">

	    <title>Ingeneria DataJR</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/construccion.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/construccion2.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
